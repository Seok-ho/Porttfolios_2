...
public class FadeInAnim5 : MonoBehaviour
{
    ...
    public static FadeInAnim5 Instance;
    ...
    public void FadeButton()    //끝 애니메이션으로 넘어감
    {
    ...
    public void FadeButton_EndAnimation()   // 다음 씬으로 전환 
    {
        button.SetActive(false);
        StartCoroutine(FadeCoroutine());
