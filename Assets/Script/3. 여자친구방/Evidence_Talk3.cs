...
public class Evidence_Talk3 : MonoBehaviour
{
    //변경할 변수
    public float delay;
    ...
    void Update()
    {
        ...
        if (Input.GetMouseButtonDown(0))    //좌클릭으로 대사 넘기는거 가능하게 
        {
            ...
            {
                End_Talk();
                // EvidenceManager2.goNextScene += 1;   //만약 증거 다 찾으면 다음씬으로 넘어갈 수 있게 (화장실의 경우 증거3개니까 3되면 Next 버튼 나옴)
            }
        }
        /*============================================================================================*/
    }
    ...
    {   //대화가 종료되면 대사창이랑 증거물 삭제시킴 
        ...
        gameObject.SetActive(false);
        EvidenceManager3.goNextScene += 1;
    }
    /*=========================================================================================*/
